<template>
  ...
  <footer class="bg-brand-grigio">
    <div class="mx-auto w-full max-w-screen-xl">
      ...
      <div
        class="bg-brand-grigio px-4 py-6 md:flex md:items-center md:justify-between"
      >
        <span class="text-sm text-white sm:text-center"
          >© 2023 <a href="#">Grop Corporation™</a>. All Rights Reserved.
        </span>
